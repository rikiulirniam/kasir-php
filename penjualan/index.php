            ...
            <section class="content">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-1">
                                <button type="submit" class="btn btn-primary" onclick="fetchData()">Cari</button>
                            </div>
                            <form method="POST" action="adddetail.php" class="row">
                                <div class="col-xs-2">
                                ...
                                <div class="col-xs-1">
                                    <input type="number" value="1" min="1" name="jumlah" required id="jumlah"
                    ...
                    <div class="body table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th width="15%" class="text-center">Nama Barang</th>
                            ...
                            <tbody>
                                <?php
                                $result = mysqli_query($mysqli, "SELECT * FROM detail_transaksi ORDER BY id DESC");
                                while ($data = mysqli_fetch_array($result)) {
                                ?>
                                <tr>
                                    <td><?php echo $data['nama'] ?></td>
                                    <td><?php echo $data['harga_jual'] ?></td>
                                    <td><?php echo $data["jumlah"] + $data['harga_jual'] ?></td>
