...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <li><a href="kelas.php"><i class="fa fa-book"></i> <span>Data Kelas</span></a></li> -->
                    ...
                    <li><a href="transaksi/index.php"><i class="fa fa-plus"></i> <span>Buat Transaksi</span></a></li>
                </ul>
            </section>
            <!-- /.sidebar -->
        </aside>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row create-transaksi" style="padding: 2em;">
                    <a href="http://localhost/penjualan/transaksi/index.php" style="padding: 1em; border: solid 2px black; width: 25%; display: flex; align-items: center; font-size: 1.4em; ">
                        <i class="fa fa-plus"></i> <span style="padding-inline:1em;"> Buat Transaksi Baru</span>
                    </a>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
