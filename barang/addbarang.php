    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?= isset($_GET['edit']) ? "Update Data Barang" : "Data Barang"  ?>
                        ...
                        <div class="box box-primary">
                            ...
                            <form action="addproses.php" method="POST">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" name="barcode" class="form-control" id="barcode"
                                            ...
                                            value="<?= isset($_GET['edit']) ? $query['barcode'] : "" ?>" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama Barang</label>
                                        <input required type="text" name="nama_barang" class="form-control"
                                            id="nama_barang" placeholder="Masukkan Nama Barang"
                                            value="<?= isset($_GET['edit']) ? $query['nama'] : "" ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Keterangan</label>
                                        <input type="text" name="keterangan" class="form-control" id="keterangan"
                                            placeholder="Masukkan Keterangan"
                                            value="<?= isset($_GET['edit']) ? $query['keterangan'] : "" ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Stok</label>
                                        <input required type="text" name="stok" class="form-control" id="stok"
                                            placeholder="Masukkan stok"
                                            value="<?= isset($_GET['edit']) ? $query['stok'] : "" ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Harga Beli</label>
                                        <input required type="text" name="harga_beli" class="form-control"
                                            id="harga_beli" placeholder="Masukkan Harga Beli"
                                            value="<?= isset($_GET['edit']) ? $query['harga_beli'] : "" ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Harga Jual</label>
                                        <input required type="text" name="harga_jual" class="form-control"
                                            id="harga_jual" placeholder="Masukkan harga_jual"
                                            value="<?= isset($_GET['edit']) ? $query['harga_jual'] : "" ?>">
                                    </div>
                                ...
                                <div class="box-footer">
                                    <input type="hidden" name="id" value="<?= isset($_GET['edit']) ? $query['id'] : 'submit' ?>">
                                    <button type="submit" name="<?= isset($_GET['edit']) ? 'edit' : 'submit' ?>"
