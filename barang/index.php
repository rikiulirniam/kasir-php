                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="/penjualan/barang/prosesbrg.php" method="POST"
                                                        class="btn-group">
                                                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                                        <a href="/penjualan/barang/addbarang.php?edit=<?= $data['barcode'] ?>"
                                                            type="button" class="btn btn-warning">Edit</a>
                                                        <button type="submit" name="delete_brg"
