...
if (isset($_POST['add_detail'])) {
    ...
    if ($oldStok > 0) {
        $stok = $barang['stok'] - 1;
        $query_stok = $mysqli->query("UPDATE barang SET stok='$stok' WHERE id='$barang_id'");
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form method="POST" action="adddetail.php?kd=<?= $_GET['kd'] . "&nama=" . $_GET['nama'] ?>"
                                class="">
                                <div class="col-xs-3">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($result)) {
                                    $total_bayar += $data['jumlah'] * $data['harga_jual'];
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td onclick="editJumlah(this, <?= $data['id']; ?>)">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <form action="prosestransaksi.php" method="POST"
                                            ...
                                            <input type="hidden" name="nama" value="<?= $_GET['nama'] ?>">
                                            <span style="font-size: 1.2em; border-right: solid 1px black; padding-inline: 0.5em;">
                                                Total Belanja : <?= rupiah($total_bayar) ?>
                                            </span>
                                            <span style="font-size: 1.2em; padding-inline: 0.5em;">
                                                Total Bayar : Rp <input type="number" min="1" name="total_bayar" value="<?= "ss" ?>">
                                            </span>

                                            <button type="submit" name="save_trn" style="margin-inline: 1em;"
